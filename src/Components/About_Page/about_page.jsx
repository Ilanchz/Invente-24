...
function About() {
    ...
    return (
        ...
        >
            ...
            <div className="bg-gray-700 bg-opacity-40 p-6 md:p-10 rounded-lg shadow-lg">
                <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-green-600 to-lime-400 mb-4 text-center">
                ...
                <div className="bg-gray-700 bg-opacity-40 p-6 md:p-10 rounded-lg shadow-lg text-center">
                    <center>
                        <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-yellow-300 mb-4">ABOUT SNU CHENNAI</h1>
                    </center>
                    <div className="flex flex-col md:flex-row items-center md:items-start">
                        <p className="text-gray-100 leading-relaxed text-lg">
                        ...
                        <img 
                            src="/snu_about.jpg" 
                            alt="SNU Chennai" 
                            className="h-full w-2/6 rounded-lg shadow-md mb-4 md:mb-0 md:ml-6"
                        />
                    </div>
                ...
                <div className="bg-gray-700 bg-opacity-40 p-6 md:p-10 rounded-lg shadow-lg text-center">
                    <center>
                        <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-teal-400 to-purple-400 mb-4">INVENTE</h1>
                    </center>
                    <div className="flex flex-col md:flex-row items-center md:items-start">
                        <img 
                            src="/invente_about.jpg" 
                            alt="INVENTE" 
                            className="w-full h-96 rounded-lg shadow-md mb-4 mr-3"
                        />
                        <img 
                        src="/invente2_about.jpg" 
                        alt="INVENTE" 
                        className="w-full h-96 rounded-lg shadow-md mb-4 ml-4"
                        />
                    </div>
