...
const departments = [
  ...
  { name: 'Commerce & Economics', image: '/images/com.jpg', path: '/department/com' },
];
...
const TimelineSection = () => {
  ...
  return (
    <div className="relative flex flex-col items-center py-8 gap-10 md:gap-20">
      {/* Vertical line */}
      <div className="absolute left-1/2 transform -translate-x-1/2 w-px h-full top-0 border-4 border-gray-300 glow-animation" id="time-container" />
...
const TimelineItem = ({ name, image, path, isLast, onClick, isOdd }) => {
  ...
  return (
    ...
    >
      ...
      <div className={`hover:animate-wiggle relative ml-6 p-8 bg-white shadow-lg rounded-lg border border-gray-200 flex-1 hover:shadow-xl transition-shadow duration-300 text-center cursor-pointer ${isOdd ? 'ml-0 mr-6' : ''}`}>
